...
final class SubtitleSettings: NSObject, NSCoding {
    ...
    override init() {
        guard
            let codedData = UserDefaults.standard.data(forKey: "subtitleSettings"),
    ...
    func save() {
        ...
        UserDefaults.standard.set(try? NSKeyedArchiver.archivedData(withRootObject: self, requiringSecureCoding: false),
                                  forKey: "subtitleSettings")
