...
extension TVChannel {
    static var primaCool: TVChannel {
        ...
        return TVChannel(id: "prima-cool", name: "Prima Cool", station: .prima, currentProgramme: programme)
    }
    static var primaLove: TVChannel {
        ...
        return TVChannel(id: "prima-love", name: "Prima Love", station: .prima, currentProgramme: programme)
    }
    static var primaMax: TVChannel {
        ...
        return TVChannel(id: "prima-max", name: "Prima Max", station: .prima, currentProgramme: programme)
    }
    static var joj: TVChannel {
        ...
        return TVChannel(id: "joj", name: "JOJ", station: .joj, currentProgramme: programme)
    }
    static var jojPlus: TVChannel {
        ...
        return TVChannel(id: "joj-plus", name: "JOJ plus", station: .joj, currentProgramme: programme)
    }
    static var jojWau: TVChannel {
        ...
        return TVChannel(id: "joj-wau", name: "JOJ wau", station: .joj, currentProgramme: programme)
    }
    static var jojFamily: TVChannel {
        ...
        return TVChannel(id: "joj-fam", name: "JOJ family", station: .joj, currentProgramme: programme)
    }
    static var nova: TVChannel {
        ...
        return TVChannel(id: "nova", name: "Nova", station: .nova, currentProgramme: programme)
    }
    static var nova2: TVChannel {
        ...
        return TVChannel(id: "nova2", name: "Nova 2", station: .nova, currentProgramme: programme)
    }
    static var novaAction: TVChannel {
        ...
        return TVChannel(id: "nova-action", name: "Nova Action", station: .nova, currentProgramme: programme)
    }
    static var novaCinema: TVChannel {
        ...
        return TVChannel(id: "nova-cinema", name: "Nova Cinema", station: .nova, currentProgramme: programme)
    }
    static var eurosport1: TVChannel {
        ...
        return TVChannel(id: "eurosport1", name: "Eurosport 1 HD", station: .eurosport, currentProgramme: programme)
    }
    static var eurosport2: TVChannel {
        ...
        return TVChannel(id: "eurosport2", name: "Eurosport 2 HD", station: .eurosport, currentProgramme: programme)
    }
    static var rtvs1: TVChannel {
        ...
        return TVChannel(id: "rtvs1", name: "Jednotka", station: .rtvs, currentProgramme: programme)
    }
    static var rtvs2: TVChannel {
        ...
        return TVChannel(id: "rtvs2", name: "Dvojka", station: .rtvs, currentProgramme: programme)
    }
    static var markiza: TVChannel {
        ...
        return TVChannel(id: "markiza", name: "Markiza", station: .markiza, currentProgramme: programme)
    }
    ...
    static var hbo: TVChannel {
        ...
        return TVChannel(id: "hbo", name: "HBO", station: .hbo, currentProgramme: programme)
    }
    static var hbo2: TVChannel {
        ...
        return TVChannel(id: "hbo2", name: "HBO 2", station: .hbo, currentProgramme: programme)
    }
}
